        ...
        {!loading && (
          <section className="flex flex-col gap-3">
            ...
            <div className="flex gap-4">
              ...
              >
                <svg width="280" height="152" viewBox="0 0 416 222" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[280px] h-[152px]">
                ...
                <path d="M109.746 175.311C108.46 175.311 107.313 175.041 106.304 174.523C105.301 174.005 104.513 173.299 103.939 172.408C103.373 171.509 103.089 170.493 103.089 169.359C103.089 168.495 103.376 167.728 103.95 167.057C104.53 166.38 105.325 165.754 106.335 165.18C107.344 164.606 108.488 164.277 109.767 164.277C110.755 164.277 111.55 164.443 112.152 164.775C112.76 165.093 113.23 165.473 113.562 165.909C113.901 166.344 114.164 166.728 114.35 167.06C114.537V159.169H117.637V175H114.609V172.522H114.35C114.164 172.86 113.894 173.248 113.541 173.683C113.196 174.119 112.719 174.499 112.11 174.824C111.502 175.149 110.714 175.311 109.746 175.311ZM110.431 172.667C111.322 172.667 112.076 172.432 112.691 171.962C113.313 171.485 113.783 170.825 114.101 169.981C114.426 169.138 114.589 168.156 114.589 167.036C114.589 165.93 114.43 164.963 114.112 164.133C113.794 163.303 113.327 162.657 112.712 162.194C112.097 161.731 111.336 161.499 110.431 161.499C109.497 161.499 108.72 161.741 108.097 162.225C107.475 162.709 107.005 163.369 106.687 164.206C106.376 165.042 106.221 165.986 106.221 167.036C106.221 168.101 106.38 169.058 106.698 169.909C107.016 170.759 107.486 171.433 108.108 171.931C108.737 172.422 109.511 172.667 110.431 172.667Z" fill="#586367"/>
