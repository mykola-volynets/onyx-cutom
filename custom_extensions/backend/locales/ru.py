LANG_CONFIG = {
    "ru": {
        ...
        "common_words": ["я", "ты", "он", "она", "оно", "мы", "вы", "они", "этот", "тот", "такой", "такая", "такое", "такие", "мой", "твой", "его", "ее", "наш", "ваш", "их", "быть", "есть", "был", "была", "было", "были", "буду", "будешь", "будет", "будем", "будете", "будут"],
    }
} 